...
- Контуры: `game/docs/vertical_slice/`, `game/docs/combat_feel/` (E1), `game/docs/run_builds/` (E2), `game/docs/run_floors/` (E3), `game/docs/save_slot/` (E4), `game/docs/imageboard/` (E5), `game/docs/zh_ek/` (E6) …
...
- Board smoke (E5): `tools\godot\Godot_v4.7.2-stable_win64_console.exe --headless --path game -s res://scripts/imageboard_smoke.gd`
- Notice smoke (E6): `tools\godot\Godot_v4.7.2-stable_win64_console.exe --headless --path game -s res://scripts/zh_ek_smoke.gd`
...
- Программа этапов: [`../docs/program/spec.md`](../docs/program/spec.md) (следующий этап после E6 — E7, до кода человек снимает B1)
