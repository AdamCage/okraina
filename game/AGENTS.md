...
- Контуры: `game/docs/vertical_slice/`, `game/docs/combat_feel/` (E1), `game/docs/run_builds/` (E2), `game/docs/run_floors/` (E3), `game/docs/save_slot/` (E4), `game/docs/imageboard/` (E5) …
...
- Программа этапов: [`../docs/program/spec.md`](../docs/program/spec.md) (следующий этап после E5 — E6)
