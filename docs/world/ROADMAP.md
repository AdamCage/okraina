...
**E6 — объявление ЖЭКа меняет следующий забег.** Класс `increment`.
Артефакты: дельта хаба или `game/docs/zh_ek/`.

E1–E5 уже идут своими контурами. Слот — `game/docs/save_slot/`, борда — `game/docs/imageboard/`.
